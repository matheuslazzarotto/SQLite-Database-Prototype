...
_"loginEureka.py"_ is the main app containing the login page. It refers to _"eureka.py"_ which runs on the terminal when login is successful (and _"eureka.py"_ refers to the database functions at _"functions.py"_)
